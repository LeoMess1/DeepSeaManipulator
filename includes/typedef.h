...
#define ROBOT_JOINT_ONE_THETA_MAX        1.44//60
#define ROBOT_JOINT_ONE_THETA_MIN       -1.44 //-60
#define ROBOT_JOINT_TWO_THETA_MAX        0.523 //30
#define ROBOT_JOINT_TWO_THETA_MIN      -1.6//-90
#define ROBOT_JOINT_THREE_THETA_MAX     1.63//90
...
#define ROBOT_JOINT_FIVE_THETA_MAX     0.3 //0
